    ...
    <>
      ...
      <div class="container-all" id="move-content">
            ...
            <div className="posts">
                ...
                <div className="post" data-category="ARTE">

                    <div className="ctn-img">
                        <img src="galeria/arte.jpg" alt=""/>
                    </div>
                    <h2>Aprende las diferentes Tecnicas de Pintura</h2>
                    <span>29 Junio 2020 - 9:26 am</span>
                    <ul className="ctn-tag">
                        <li>ACRÍLICA</li>
                        <li>ACUARELA</li>
                        <li>PASTEL</li>
                ...
                <div className="post" data-category="IDIOMAS">

                    <div className="ctn-img">
                        <img src="galeria/idiomas.jpg" alt=""/>
                    </div>
                    <h2>Aprende las distintos idiomas</h2>
                    <span>12 Julio 2020 - 10:26 am</span>
                    <ul className="ctn-tag">
                        <li>INGLES</li>
                        <li>FRANCES</li>
                        <li>TAILANDES</li>
                ...
                <div className="post" data-category="COCINA">

                    <div className="ctn-img">
                        <img src="galeria/cocina.jpg" alt=""/>
                    </div>
                    <h2>Aprende las diferentes Recetas</h2>
                    <span>21 Agosto 2020 - 16:30 am</span>
                    <ul className="ctn-tag">
                        <li>Gastronomía</li>
                    </ul>
                    <a href="#"><button>Leer más</button></a>
